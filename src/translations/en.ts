export default {
    ...
    hero: {
        subtitle: 'Law Office',
        description:
            'We provide high-quality legal expertise backed by many years of experience.',
    ...
    about: {
        label: 'About us',
        title: 'Your trusted legal partner in Bijeljina',
        imageAlt: 'Puljak & Marjanović Law Office',
        descriptionOne:
            'Puljak & Marjanović Law Office is a reputable legal practice based in Bijeljina, specialized in a wide range of legal services. With our team of experienced legal professionals, we are committed to providing legal assistance of the highest quality.',
        descriptionTwo:
        ...
        features: {
            ...
            reliability: {
                title: 'Reliability',
                description: 'Integrity and professionalism in every aspect of our work',
            },
            availability: {
                title: 'Availability',
                description: 'Always available to our clients for consultations and support',
            },
        },
    },
    ...
    services: {
        label: 'Our services',
        title: 'High-quality legal services',
        description:
            'We offer comprehensive legal services tailored to the needs of our clients, with expertise and dedication in every area of our work.',
        ...
        cta: {
            ...
            description:
                'Contact us for a free initial consultation and find out how we can help.',
    ...
    contact: {
        ...
        description:
            'If you need legal assistance or advice, feel free to contact us. We are here to answer all your questions.',
        ...
        info: {
            ...
            workingHours: {
                title: 'Working hours',
                lineOne: 'Mon - Fri: 08:00 - 16:00',
                lineTwo: 'Saturday: By appointment',
            },
        },

        consultation: {
            kicker: 'Legal consultation',
            title: 'Request a legal consultation.',
            description:
                'Contact us for initial information, legal advice or to arrange a consultation. We respond professionally, discreetly and as promptly as possible.',
        },
    ...
    team: {
        ...
        description:
            'A team of experienced legal professionals dedicated to achieving the best results for our clients with professionalism, integrity and expertise.',
        ...
        quote: {
            text: 'Our strength lies in our team – a combination of experience, knowledge and dedication to every client.',
    ...
    footer: {
        description:
            'Your trusted legal partner in Bijeljina, with many years of experience and a commitment to excellence.',
        ...
        bottomText: 'Law Office | Bijeljina, BiH',
    },
}