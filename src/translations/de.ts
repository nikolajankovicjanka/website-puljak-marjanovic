export default {
    ...
    hero: {
        ...
        description:
            'Wir bieten hochwertige juristische Expertise auf Grundlage langjähriger Erfahrung.',
    ...
    about: {
        label: 'Über uns',
        title: 'Ihr verlässlicher Rechtspartner in Bijeljina',
        imageAlt: 'Anwaltskanzlei Puljak & Marjanović',
        descriptionOne:
            'Die Anwaltskanzlei Puljak & Marjanović ist eine renommierte Kanzlei mit Sitz in Bijeljina, spezialisiert auf ein breites Spektrum juristischer Dienstleistungen. Mit unserem erfahrenen Team widmen wir uns der Rechtsberatung und rechtlichen Unterstützung auf höchstem Niveau.',
        descriptionTwo:
        ...
        features: {
            ...
            clients: {
                ...
                description: 'Individuelle Betreuung jedes Mandanten und seiner Bedürfnisse',
            },
            reliability: {
                title: 'Zuverlässigkeit',
                description: 'Integrität und Professionalität in jedem Bereich unserer Arbeit',
            },
            availability: {
                title: 'Erreichbarkeit',
                description: 'Für Beratungen und Unterstützung stets für unsere Mandanten da',
            },
        },
    },
    ...
    services: {
        ...
        title: 'Juristische Dienstleistungen auf hohem Niveau',
        description:
            'Wir bieten umfassende juristische Dienstleistungen, die auf die Bedürfnisse unserer Mandanten zugeschnitten sind – mit Fachkompetenz und Engagement in jedem Bereich unserer Arbeit.',

        items: {
            civil: {
                title: 'ZIVILRECHT',
                description:
                    'Vertretung in Zivilverfahren, Vollstreckungsverfahren und außerstreitigen Verfahren vor den zuständigen Gerichten in der Republik Srpska und der Föderation Bosnien und Herzegowina, in Angelegenheiten aus allen Bereichen des Zivilrechts.',
            },
    ...
    contact: {
        ...
        description:
            'Wenn Sie rechtliche Unterstützung oder Beratung benötigen, kontaktieren Sie uns gerne. Wir beantworten alle Ihre Fragen.',
        ...
        info: {
            ...
            workingHours: {
                ...
                lineOne: 'Mo - Fr: 08:00 - 16:00',
                lineTwo: 'Samstag: Nach Vereinbarung',
            },
        },

        consultation: {
            kicker: 'Rechtsberatung',
            title: 'Fordern Sie eine Rechtsberatung an.',
            description:
                'Kontaktieren Sie uns für erste Informationen, rechtlichen Rat oder zur Vereinbarung eines Beratungstermins. Wir antworten professionell, diskret und so schnell wie möglich.',
        },
        ...
        form: {
            ...
            emailSubject: 'Neue Nachricht von der Website Puljak & Marjanović',

            errors: {
                missingAccessKey: 'Der Web3Forms Access Key fehlt in der .env-Datei.',
                requiredFields: 'Bitte füllen Sie alle Pflichtfelder aus.',
                submitFailed: 'Beim Senden der Nachricht ist ein Fehler aufgetreten.',
        ...
        map: {
            ...
            title: 'Besuchen Sie uns in unserer Kanzlei',
            address: 'Atinska 19, Bijeljina 76300',
            iframeTitle: 'Standort der Anwaltskanzlei Puljak & Marjanović',
        },
    },

    team: {
        label: 'Unser Team',
        title: 'Lernen Sie unsere Anwältinnen kennen',
        description:
            'Ein Team erfahrener Juristinnen, das sich mit Professionalität, Integrität und Fachkompetenz für die besten Ergebnisse unserer Mandanten einsetzt.',
        ...
        quote: {
            text: 'Unsere Stärke liegt im Team – in der Kombination aus Erfahrung, Wissen und Engagement für jeden Mandanten.',
    ...
    footer: {
        description:
            'Ihr verlässlicher Rechtspartner in Bijeljina mit langjähriger Erfahrung und Engagement für höchste Qualität.',
        ...
        bottomText: 'Anwaltskanzlei | Bijeljina, BiH',
    },
}